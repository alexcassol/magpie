defmodule Magpie.Files.SaveUrl do
  ...
  ## Example
    ...
    Magpie.Files.SaveUrl.save_url(client, "/a.txt", "http://example.com/a.txt")
  ...
  def save_url(client, path, url) do
    ...
    post(client, "/files/save_url", body)
  end
  ...
  ## Example
    ...
    Magpie.Files.SaveUrl.check_job_status(client, "34g93hh34h04y384084")

  More info at: https://www.dropbox.com/developers/documentation/http/documentation#files-save_url
  """
  def check_job_status(client, async_job_id) do
    body = %{"async_job_id" => async_job_id}
    post(client, "/files/save_url/check_job_status", body)
  end
end
